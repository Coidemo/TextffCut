...
from core.constants import BatchSizeLimits, MemoryThresholds
...
class TestAlignmentDiagnostics(unittest.TestCase):
    ...
    def test_calculate_optimal_batch_size(self, mock_vmem):
        ...
        batch_size = self.diagnostics._calculate_optimal_batch_size(
            available_memory_gb=8.0,
            segment_count=100,
            model_memory_mb=300.0,
            base_memory_percent=40.0
        )
