...
class GatewayContainer(containers.DeclarativeContainer):
    ...
    # テキスト処理ゲートウェイ
    # text_processor_gateway = providers.Singleton(SearchBasedLCSTextProcessorGateway)  # LCSベース
    text_processor_gateway = providers.Singleton(SequenceMatcherTextProcessorGateway)  # SequenceMatcherベース
