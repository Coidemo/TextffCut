...
from use_cases.exceptions import AudioExtractionError, SilenceDetectionError, VideoProcessingError, SegmentCombineError
...
class TestVideoProcessorGatewayAdapter:
    ...
    def test_combine_segments_success(self, mock_legacy_processor):
        ...
        segment_paths = [
            ...
            FilePath("/tmp/seg2.mp4"),
            FilePath("/tmp/seg3.mp4")
        ]
