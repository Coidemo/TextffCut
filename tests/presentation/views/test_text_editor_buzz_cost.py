...
class TestBuzzClipCostCalculation:
    ...
    def test_cost_comparison_gpt4_vs_gpt4o(self):
        ...
        # GPT-4のコスト
        gpt4_cost = (
            (usage["prompt_tokens"] / 1_000_000) * gpt4_input_cost_per_million +
            (usage["completion_tokens"] / 1_000_000) * gpt4_output_cost_per_million
        )
        
        # GPT-4oのコスト
        gpt4o_cost = (
            (usage["prompt_tokens"] / 1_000_000) * gpt4o_input_cost_per_million +
            (usage["completion_tokens"] / 1_000_000) * gpt4o_output_cost_per_million
        )
