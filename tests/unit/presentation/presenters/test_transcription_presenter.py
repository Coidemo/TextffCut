...
class TestTranscriptionPresenter:
    ...
    @pytest.fixture
    def presenter(self, view_model, mock_transcribe_use_case, mock_load_cache_use_case,
                  mock_file_gateway, mock_transcription_gateway, mock_error_handler):
        """テスト用Presenter"""
    ...
    def test_handle_error(self, presenter):
        ...
        mock_error_handler.handle_error.assert_called_once_with(
            error, context="テストコンテキスト", raise_after=False
        )
