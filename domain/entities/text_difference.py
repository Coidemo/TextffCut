...
class TextDifference:
    ...
    def from_text_comparison(
        cls, original_text: str, edited_text: str, word_timestamps: list[dict] | None = None
    ) -> "TextDifference":
        """テキスト比較から差分エンティティを作成"""
        ...
        return cls(id=str(uuid4()), original_text=original_text, edited_text=edited_text, differences=differences)
