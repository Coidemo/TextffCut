...
def test_api_alignment():
    ...
    test_segments = [
        ...
        {"start": 2.0, "end": 4.0, "text": "日本語のアライメント"},
    ]

    try:
        # アライメント処理を実行
        print("\n1. アライメントサブプロセスを実行...")
        aligned_segments = transcriber._align_in_subprocess(test_audio_path, test_segments, None)  # progress_callback
...
def create_test_audio():
    ...
    # 4秒の無音WAVファイルを生成
    cmd = ["ffmpeg", "-y", "-f", "lavfi", "-i", "anullsrc=r=16000:cl=mono:d=4", "-ar", "16000", "-ac", "1", temp_wav]
