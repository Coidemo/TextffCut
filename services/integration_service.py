...
from core.error_handling import ValidationError, ProcessingError
    ...
    def full_process(
        ...
        try:
            ...
            return self.wrap_error(
                ProcessingError(f"処理中にエラーが発生しました: {str(e)}")
            )
            ...
            for i, format_type in enumerate(export_formats):
                ...
                if export_result.success:
                    export_results.append({
                        'format': format_type,
                        'files': export_result.data.get('files', [])
                    })
    ...
    def process_with_silence_removal(
        ...
        try:
            ...
            if export_video:
                ...
                video_result = self._export_video_with_silence_removal(
                    video_file, processed_segments, output_dir
                )
