...
from worker_transcribe_v2 import (
    WorkerConfig, ConfigLoader, MemoryManager, 
    TranscribeOnlyHandler, FullProcessHandler, SeparatedModeHandler,
    TranscriptionWorker
)
...
class TestTranscriptionWorker(unittest.TestCase):
    ...
    def test_create_task_handler_api_mode(self):
        ...
        from worker_transcribe_v2 import FullProcessHandler
    ...
    def test_create_task_handler_local_mode(self):
        ...
        from worker_transcribe_v2 import SeparatedModeHandler
