...
def test_waveform_generation():
    ...
    for seg in segments:
        ...
        waveform_data = processor.extract_waveform(video_path, seg["start"], seg["end"], seg["id"])
...
def test_silence_detection():
    ...
    waveform_data = WaveformData(
        segment_id="silence_test", sample_rate=sr, samples=samples, duration=duration, start_time=0.0, end_time=duration
    )
