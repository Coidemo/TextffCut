                ...
                if pos_tag == '名詞':
                    ...
                    if surface in '月日時分秒年':
                        ...
                        if i > 0:
                            ...
                            if prev_pos == '名詞' and (prev_surface.isdigit() or any(c in prev_surface for c in '0123456789')):
                                score *= 0.05  # 強く避ける
                    ...
                    # 数詞かどうかをチェック
                        ...
                        if i + 1 < len(boundaries):
                            ...
                            if next_pos == '名詞' and (next_surface.isdigit() or any(c in next_surface for c in '年月日時分秒') or next_surface in '年月日時分秒'):
                                score *= 0.05  # 強く避ける
