...
from core.types import (
    TimeSeconds, WordInfo, SegmentDict, ProcessingStatus,
    AlignmentStatus, VideoPath, ModelSize, ProcessingMode,
    ValidationResult
)
...
class WordInfo:
    """単語情報（型安全版）"""
    word: str
    start: Optional[TimeSeconds] = None
    end: Optional[TimeSeconds] = None
...
class TranscriptionSegmentV2:
    ...
    def _is_word_valid(self, word: Union[WordInfo, Dict[str, Any]]) -> bool:
        """単語情報が有効かチェック"""
...
class ProcessingMetadata:
    ...
    total_processing_time: Optional[TimeSeconds] = None
...
class TranscriptionResultV2:
    ...
    def is_complete(self) -> bool:
        """処理が完了しているかチェック"""
        return (self.transcription_status == "completed" and
                self.alignment_status == "completed")
