...
class FileGatewayAdapter(IFileGateway):
    ...
    def create_temp_directory(
        ...
        try:
            ...
            raise IOError(f"Failed to create temp directory: {e}")
    ...
    def get_relative_path(
        ...
        try:
            ...
            raise IOError(f"Failed to get relative path: {e}")
    ...
    def get_absolute_path(self, path: FilePath) -> FilePath:
        ...
        try:
            ...
            raise IOError(f"Failed to get absolute path: {e}")