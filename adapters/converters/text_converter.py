...
class TextConverter:
    ...
    @staticmethod
    def legacy_difference_to_domain(
        legacy_diff: LegacyTextDifference
    ) -> domain.TextDifference:
        """
    ...
    @staticmethod
    def domain_to_time_ranges(
        domain_ranges: List[vo.TimeRange]
    ...
    @staticmethod
    def adjusted_segments_to_domain(
        segments: List[dict],
        markers: List[str]
    ) -> List[domain.TranscriptionSegment]:
        """
