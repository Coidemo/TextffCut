...
class KeyboardShortcuts:
    ...
    def __init__(self):
        self.shortcuts: Dict[str, Dict[str, Any]] = {
            ...
            # セグメント移動
            "arrowleft": {
                "description": "前のセグメントへ",
                "action": "previous_segment",
                "modifier": None
            },
            "arrowright": {
                "description": "次のセグメントへ",
                "action": "next_segment",
                "modifier": None
            },
            # 時間調整（粗調整）
            ...
            "cmd+z": {
                "description": "元に戻す（Mac）",
                "action": "undo",
                "modifier": "cmd"
            },
            "cmd+shift+z": {
                "description": "やり直し（Mac）",
                "action": "redo",
                "modifier": "cmd+shift"
            }
        }
        
        self.action_handlers: Dict[str, Optional[Callable]] = {}
        self.enabled = True
    ...
    def get_help_text(self) -> str:
        ...
        categories = {
            ...
            "時間調整": ["arrowup", "arrowdown", "shift+arrowleft", "shift+arrowright", 
