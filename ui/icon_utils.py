...
def get_icon_svg() -> str:
    """
    テーマに応じたアイコンSVGを返す
    インラインSVGとCSSクラスを使用した動的な色切り替え
    
    Returns:
        SVG文字列
    """
    # CSSクラスとインラインSVGを組み合わせた実装
    # ThemeDetectorの代わりに、親要素のクラスで切り替える
    return """
<style>
/* デフォルト（ライトモード） */
.icon-dynamic { fill: #2a363b; }
.icon-red { fill: #fd444d; }

/* ダークモード - Streamlitのダークテーマクラスで検出 */
[data-theme="dark"] .icon-dynamic { fill: #ffffff; }
[data-theme="dark"] .icon-red { fill: #fd444d; }

/* 追加のセレクタ（Streamlitの構造に対応） */
.stApp[data-theme="dark"] .icon-dynamic { fill: #ffffff; }
.main[data-theme="dark"] .icon-dynamic { fill: #ffffff; }

/* prefers-color-schemeも併用 */
@media (prefers-color-scheme: dark) {
    .icon-dynamic { fill: #ffffff; }
}
</style>
...
<path class="icon-dynamic" d="M69.41,89.96c-5.86.73-11.72,1.74-17.52,2.4,4.22-9.39,6.59-19.65,11.44-28.76,3.08-5.79,7.68-11,13.6-14,3.3-1.67,6.38-2.77,9.92-.96,2.77,1.41,3.26,4.72,1.62,7.23-1.86,2.85-3.67,5.17-5.43,8.25-4.81,8.45-8.84,17.37-13.64,25.84Z"/>
<path class="icon-dynamic" d="M95.03,65.78h19.8c4.77,1.39,4.4,7.98-.69,8.55-6.03.67-13.2-.39-19.35-.02-4.41-1.47-4.15-7.26.24-8.53Z"/>
</svg>
<script>
// 動的にdata-theme属性を設定
(function() {
    const updateTheme = () => {
        ...
        document.querySelectorAll('.stApp, .main').forEach(el => {
