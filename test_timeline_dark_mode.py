...
def test_color_scheme_light_mode():
    ...
    # 必要なカラーキーが存在することを確認
    required_keys = [
        "waveform_positive", "waveform_negative", "waveform_silence",
        "segment_active", "segment_inactive", "segment_hover",
        "boundary_marker", "playhead",
        "background", "grid_lines", "grid_major",
        "text_primary", "text_secondary",
        "selection_bg", "hover_bg", "plotly_template"
    ]
